...
export class Wonderland extends Scene {
    constructor() {
        ...
        this.materials = {
            origin: new Material(new defs.Phong_Shader(), { ambient: 0.8, diffusivity: 0.8, color: color(0.6, 0, 0.6, 1) }),
    ...
    display(context, program_state) {
        ...
        // Draw walls.
        this.shapes.walls.draw(context, program_state, Mat4.scale(10, 10, 10), this.materials.stars);
    }
}
